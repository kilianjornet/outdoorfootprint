...
class HomeService extends GetConnect implements GetxService {
  final refreshTokenService = RefreshTokenService();

  Future<dynamic> getUserTotal() async {
    ...
    try {
      ...
      final response = await get(
        '${ApiManager.baseUrl}${ApiManager.getUserTotalCalculation}',
        headers: {
