...
class MobilityService extends GetConnect implements GetxService {
  final refreshTokenService = RefreshTokenService();

  Future<dynamic> submitMobility({
    ...
    try {
      ...
      final response = await post(
        '${ApiManager.baseUrl}${ApiManager.createMobility}',
        {
          "userId": userId,
